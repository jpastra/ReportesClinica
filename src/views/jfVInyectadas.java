 ...
 */
public class jfVInyectadas extends javax.swing.JFrame {
ResultSet rs;
private PBvInyectadas task01Inf;
private PBvInyectadasCveDH task02Inf;
private PBvInyectadasCveD task03Inf;
private PBvInyectadasD task04Inf;
    /**
     * Creates new form jfVacunas
     */
    public jfVInyectadas() {
        initComponents();
    ...
    public void vInyectadas() throws SQLException {
        ...
        rs = Conexiondb.Consulta("SELECT INMCVE  AS CLAVE, INMDES AS DESCRIPCION, TO_CHAR(INMFEC,'dd/MM/yyyy') AS FECHA, SUM (INMCANT) AS TOTAL FROM INMPAC WHERE INMFEC BETWEEN TO_DATE('" + strDateD + "','dd/MM/yyyy') AND TO_DATE('" + strDateH + "','dd/MM/yyyy') AND INMDES NOT LIKE '%SUBL%' GROUP BY INMCVE, INMDES, INMFEC ORDER BY CLAVE");
    ...
    public void vInyectadasCveDH() throws SQLException {
        ...
        rs = Conexiondb.Consulta("SELECT INMCVE  AS CLAVE, INMDES AS DESCRIPCION, TO_CHAR(INMFEC,'dd/MM/yyyy') AS FECHA, SUM (INMCANT) AS TOTAL FROM INMPAC WHERE INMFEC BETWEEN TO_DATE('" + strDateD + "', 'dd/MM/yyyy') AND TO_DATE('" + strDateH + "', 'dd/MM/yyyy') AND INMCVE IN (" + jt_cve.getText() + ") AND INMDES NOT LIKE '%SUBL%' GROUP BY INMCVE, INMDES, INMFEC ORDER BY CLAVE");
    ...
    public void vInyectadasCveD() throws SQLException {
        ...
        rs = Conexiondb.Consulta("SELECT INMCVE  AS CLAVE, INMDES AS DESCRIPCION, TO_CHAR(INMFEC,'dd/MM/yyyy') AS FECHA, SUM (INMCANT) AS TOTAL FROM INMPAC WHERE INMFEC = TO_DATE('" + strDateD + "', 'dd/MM/yyyy') AND INMCVE IN (" + jt_cve.getText() + ") AND INMDES NOT LIKE '%SUBL%' GROUP BY INMCVE, INMDES, INMFEC ORDER BY CLAVE");
        ...
        public void vInyectadasD() throws SQLException {
        ...
        rs = Conexiondb.Consulta("SELECT INMCVE  AS CLAVE, INMDES AS DESCRIPCION, TO_CHAR(INMFEC,'dd/MM/yyyy') AS FECHA, SUM (INMCANT) AS TOTAL FROM INMPAC WHERE INMFEC = TO_DATE('" + strDateD + "','dd/MM/yyyy') AND INMDES NOT LIKE '%SUBL%' GROUP BY INMCVE, INMDES, INMFEC ORDER BY CLAVE");
    ...
    private void initComponents() {
        ...
        setTitle("Reporte De Totales De Vacunas Inyectadas");
        ...
        jl_titulo.setText("REPORTE DE TOTALES DE VACUNAS INYECTADAS");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jl_tt_reg, javax.swing.GroupLayout.DEFAULT_SIZE, 123, Short.MAX_VALUE))
    ...
    private void btnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultaActionPerformed
        ...
        } else if(jt_cve.getText().isEmpty() && jd_Desde.getDate() != null && jd_Hasta.getDate() != null)
        {
            ...
            JOptionPane.showMessageDialog(null, "La consulta debe de ser ingresando la Descripcion a excluir \n                 y Desde que Fecha desea la consulta \n                  o un rango de Fecha Desde - Hasta");
        }
    ...
    private void btn_imprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_imprimirActionPerformed
        ...
        try{
            MessageFormat headerformat = new MessageFormat("Reporte Vacunas Inyectadas"); //encabezado
            MessageFormat footerformat = new MessageFormat("Page - {0}"); //
            jt_consulta_vacunas.print(JTable.PrintMode.FIT_WIDTH, headerformat, footerformat);  //imprime la JTable
        } catch (PrinterException ex) {
        Logger.getLogger(jfVInyectadas.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    private void btn_exportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_exportarActionPerformed
       ...
       if(chooser.showSaveDialog(null)==JFileChooser.APPROVE_OPTION){
           ...
           nom.add("Reporte Vacunas Inyectadas");
           ...
           try{
               ...
               if(e.export())
               {
                   JOptionPane.showMessageDialog(null, "Total de Registros exportados a Excel: " + totalR, "Reporte Vacunas Inyectadas", JOptionPane.INFORMATION_MESSAGE);
               }
           }
           catch(Exception e)
           {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfVInyectadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new jfVInyectadas().setVisible(true);
            }
        });
    }
    ...
    class PBvInyectadas extends SwingWorker<Void, Void> {
    ...
    class PBvInyectadasCveDH extends SwingWorker<Void, Void> {
    ...
    class PBvInyectadasCveD extends SwingWorker<Void, Void> {
    ...
    class PBvInyectadasD extends SwingWorker<Void, Void> {

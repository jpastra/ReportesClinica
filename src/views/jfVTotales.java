 ...
 */
public class jfVTotales extends javax.swing.JFrame {
ResultSet rs;
private PBvTotal task01Inf;
private PBvTotalCveDH task02Inf;
private PBvTotalCveD task03Inf;
private PBvTotalD task04Inf;
    /**
    ...
    public void vTotal() throws SQLException {
        ...
        rs = Conexiondb.Consulta("SELECT INMCVE  AS CLAVE, INMDES AS DESCRIPCION, TO_CHAR(INMFEC,'dd/MM/yyyy') AS FECHA, SUM (INMCANT) AS TOTAL FROM INMPAC WHERE INMFEC BETWEEN TO_DATE('" + strDateD + "','dd/MM/yyyy') AND TO_DATE('" + strDateH + "','dd/MM/yyyy') GROUP BY INMCVE, INMDES, INMFEC ORDER BY CLAVE");
    ...
    public void vTotalCveDH() throws SQLException {
        ...
        rs = Conexiondb.Consulta("SELECT INMCVE  AS CLAVE, INMDES AS DESCRIPCION, TO_CHAR(INMFEC,'dd/MM/yyyy') AS FECHA, SUM (INMCANT) AS TOTAL FROM INMPAC WHERE INMFEC BETWEEN TO_DATE('" + strDateD + "', 'dd/MM/yyyy') AND TO_DATE('" + strDateH + "', 'dd/MM/yyyy') AND INMCVE IN (" + jt_cve.getText() + ") GROUP BY INMCVE, INMDES, INMFEC ORDER BY CLAVE");
    ...
    public void vTotalCveD() throws SQLException {
        ...
        rs = Conexiondb.Consulta("SELECT INMCVE  AS CLAVE, INMDES AS DESCRIPCION, TO_CHAR(INMFEC,'dd/MM/yyyy') AS FECHA, SUM (INMCANT) AS TOTAL FROM INMPAC WHERE INMFEC = TO_DATE('" + strDateD + "', 'dd/MM/yyyy') AND INMCVE IN (" + jt_cve.getText() + ") GROUP BY INMCVE, INMDES, INMFEC ORDER BY CLAVE");
      ...
      public void vTotalD() throws SQLException {
        ...
        rs = Conexiondb.Consulta("SELECT INMCVE  AS CLAVE, INMDES AS DESCRIPCION, TO_CHAR(INMFEC,'dd/MM/yyyy') AS FECHA, SUM (INMCANT) AS TOTAL FROM INMPAC WHERE INMFEC = TO_DATE('" + strDateD + "','dd/MM/yyyy') GROUP BY INMCVE, INMDES, INMFEC ORDER BY CLAVE");
    ...
    private void initComponents() {
        ...
        setTitle("Reporte De Vacunas Totales");
        ...
        jl_titulo.setText("REPORTE DE VACUNAS TOTALES");
    ...
    private void btnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultaActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Ingresa la Clave o desde que fecha hasta que fecha \ndeseas hacer la consulta de las Vacunas");
        } else if(jt_cve.getText().isEmpty() && jd_Desde.getDate() != null && jd_Hasta.getDate() != null)
        {
            
                task01Inf = new PBvTotal();
                task01Inf.execute();
            
        }else if(jt_cve.getText().length() > 0 && jd_Desde.getDate() != null && jd_Hasta.getDate() != null)
        {
            
                task02Inf = new PBvTotalCveDH();
                task02Inf.execute();
            
        }else if(jt_cve.getText().length() > 0 && jd_Desde.getDate() != null && jd_Hasta.getDate() == null)
        {
            
                task03Inf = new PBvTotalCveD();
                task03Inf.execute();
            
        }else if(jt_cve.getText().isEmpty() && jd_Desde.getDate() != null && jd_Hasta.getDate() == null)
        {
                task04Inf = new PBvTotalD();
                task04Inf.execute();
    ...
    private void btn_imprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_imprimirActionPerformed
        ...
        try{
            MessageFormat headerformat = new MessageFormat("Reporte Vacunas Totales"); //encabezado
            MessageFormat footerformat = new MessageFormat("Page - {0}"); //
            jt_consulta_vacunas.print(JTable.PrintMode.FIT_WIDTH, headerformat, footerformat);  //imprime la JTable
        } catch (PrinterException ex) {
        Logger.getLogger(jfVTotales.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    private void btn_exportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_exportarActionPerformed
       ...
       if(chooser.showSaveDialog(null)==JFileChooser.APPROVE_OPTION){
           ...
           nom.add("Reporte Vacunas Totales");
           ...
           try{
               ...
               if(e.export())
               {
                   JOptionPane.showMessageDialog(null, "Total de Registros exportados a Excel: " + totalR, "Reporte Vacunas Totales", JOptionPane.INFORMATION_MESSAGE);
               }
           }
           catch(Exception e)
           {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfVTotales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new jfVTotales().setVisible(true);
            }
        });
    }
    ...
    class PBvTotal extends SwingWorker<Void, Void> {
    ...
    class PBvTotalCveDH extends SwingWorker<Void, Void> {
    ...
    class PBvTotalCveD extends SwingWorker<Void, Void> {
    ...
    class PBvTotalD extends SwingWorker<Void, Void> {

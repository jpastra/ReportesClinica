 ...
 */
public class jfCSubsecuentes extends javax.swing.JFrame {
ResultSet rs;
private PBvCSubSecDH task01Inf;
private PBvCSubSecD task02Inf;
    /**
     * Creates new form jfVacunas
     */
    public jfCSubsecuentes() {
        initComponents();
    ...
    public void vCSubSecDH() throws SQLException {
        ...
        rs = Conexiondb.Consulta("SELECT A.PACNEXP AS EXPEDIENTE, A.PACNOM AS NOMBRE, TO_CHAR(B.NEVFEC,'dd/MM/yyyy') AS FECHA, B.NEVREV AS REVISION, COUNT (*) AS TOTAL FROM PACCAT A, NEVPAC B WHERE B.NEVFEC BETWEEN TO_DATE('"+strDateD+"', 'dd/MM/yyyy') AND TO_DATE('"+strDateH+"', 'dd/MM/yyyy') AND A.PACNEXP=B.PACNEXP GROUP BY A.PACNEXP, A.PACNOM, B.NEVFEC, B.NEVREV");
        ...
        this.jt_consulta_subsecuentes.setModel(modelo);
        ...
        if (rs.next() == false) {
            ...
            for (int fila = 0; fila < jt_consulta_subsecuentes.getRowCount(); fila++) {
                a = String.valueOf(jt_consulta_subsecuentes.getValueAt(fila, 4));
                b = Integer.valueOf(a);
                total = total + b;
            }
    ...
    public void vCSubSecD() throws SQLException {
        ...
        rs = Conexiondb.Consulta("SELECT A.PACNEXP AS EXPEDIENTE, A.PACNOM AS NOMBRE, TO_CHAR(B.NEVFEC,'dd/MM/yyyy') AS FECHA , B.NEVREV AS REVISION, COUNT (*) AS TOTAL FROM PACCAT A, NEVPAC B WHERE B.NEVFEC = TO_DATE('"+strDateD+"', 'dd/MM/yyyy') AND A.PACNEXP=B.PACNEXP GROUP BY A.PACNEXP, A.PACNOM, B.NEVFEC, B.NEVREV");
    ...
    public void tt_rec() {
        int tt_reg = this.jt_consulta_subsecuentes.getRowCount();
        int ttRow = tt_reg - 1;
        if (ttRow > 0) {
    ...
    private void initComponents() {
        ...
        jt_consulta_subsecuentes = new javax.swing.JTable();
        ...
        setTitle("Reporte de Consultas Subsecuentes");
        ...
        jl_titulo.setText("REPORTE DE CONSULTAS SUBSECUENTES");
        ...
        jt_consulta_subsecuentes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jt_consulta_subsecuentes);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jl_tt_reg, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultaActionPerformed
        ...
        } else if(jd_Desde.getDate() != null && jd_Hasta.getDate() != null)
        {
                ...
                task01Inf = new PBvCSubSecDH();
                task01Inf.execute();
            
        }else if(jd_Desde.getDate() != null && jd_Hasta.getDate() == null)
        {
            
                task02Inf = new PBvCSubSecD();
                task02Inf.execute();
    ...
    private void btn_imprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_imprimirActionPerformed
        ...
        try{
            MessageFormat headerformat = new MessageFormat("Reporte de Consultas Subsecuentes"); //encabezado
            MessageFormat footerformat = new MessageFormat("Page - {0}"); //
            jt_consulta_subsecuentes.print(JTable.PrintMode.FIT_WIDTH, headerformat, footerformat);  //imprime la JTable
        } catch (PrinterException ex) {
        Logger.getLogger(jfCSubsecuentes.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    private void btn_exportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_exportarActionPerformed
       if(this.jt_consulta_subsecuentes.getRowCount() == 0)
       {
       ...
       int totalR = jt_consulta_subsecuentes.getRowCount();
       ...
       if(chooser.showSaveDialog(null)==JFileChooser.APPROVE_OPTION){
           ...
           tb.add(jt_consulta_subsecuentes);
           nom.add("Reporte Consultas Subsecuentes");
           ...
           try{
               ...
               if(e.export())
               {
                   JOptionPane.showMessageDialog(null, "Total de Registros exportados a Excel: " + totalR, "Reporte Consultas Subsecuentes", JOptionPane.INFORMATION_MESSAGE);
               }
           }
           catch(Exception e)
           {
    ...
    private void btn_limpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_limpiarActionPerformed
        ...
        this.jt_consulta_subsecuentes.setModel(dTable);
    ...
    private void btn_reporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_reporteActionPerformed
        if (this.jt_consulta_subsecuentes.getRowCount() == 0) {
            ...
            if (chooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
                ...
                List<String> nom = new ArrayList<>();
                tb.add(jt_consulta_subsecuentes);
                nom.add("Consultas Subsecuentes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfCSubsecuentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new jfCSubsecuentes().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jt_consulta_subsecuentes;
    // End of variables declaration//GEN-END:variables

    class PBvCSubSecDH extends SwingWorker<Void, Void> {
    ...
    class PBvCSubSecD extends SwingWorker<Void, Void> {
